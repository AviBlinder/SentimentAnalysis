...
sum_negatives_confirmed <- sum_negatives_negated + sum(str1[idx_found_neg_words_minus2] %in% c(confirmation_words))

sum_positives = sum_positives + sum_positives_confirmed
sum_negatives = sum_negatives + sum_positives_confirmed
